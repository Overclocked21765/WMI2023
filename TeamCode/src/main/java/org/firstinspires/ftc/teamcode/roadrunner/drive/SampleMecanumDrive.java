...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(18, 0, 0.1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(13, 0, 0.25);

    public static double LATERAL_MULTIPLIER = 1.129732;
