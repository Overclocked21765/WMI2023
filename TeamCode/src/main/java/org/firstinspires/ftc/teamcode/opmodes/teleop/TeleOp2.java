...
public class TeleOp2 extends OpMode {
    ...
    boolean preparingToGoDown;
    boolean readyToGoDown;
    ...
    public void loop(){
        ...
        */
        ...
        double currentLoop = loopTimer.time();
        ...
        if (currentLoop > maxLoop){
            maxLoop = currentLoop;
        } else if (currentLoop < minLoop){
            minLoop = currentLoop;
        }

        telemetry.addData("Current Loop Time: ", currentLoop);
